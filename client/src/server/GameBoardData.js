 ...
 */
 ...
 import {GameShipData} from "GameShipData";
 import {EnumPosition} from "../utilities";
...
let GameBoardData = class{
    ...
    guess(x, y){
         ...
         * @return {EnumPosition} - Returns whether the guess is a hit/miss/sink.
         */
        ...
        for (let i = 0; i < this._remainingShips.length; i++){
            ...
            if (classification == EnumPosition.HIT){
                return EnumPosition.HIT;

            }
            else if (classification == EnumPosition.SINK){
                this._remainingShips.splice(i, 1);
                this._sunkShip.push(ship);
                return EnumPosition.SINK;
            }
        }
        return EnumPosition.MISS;
    }
