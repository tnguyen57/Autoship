...
ShipFactory = class{
    /**
     * Create a ship using an x and y coordinate of the point closest to (0, 0), whether it is horizontal or vertical,
    ...
    static newBasicShip(x, y, isVertical, id){
        ...
        return new ShipData(miscFunctions.generateShip(size, {x: x, y: y}, orientation), id);
    }
